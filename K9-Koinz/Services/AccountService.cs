...
namespace K9_Koinz.Services {
    public interface IAccountService : ICustomService {
        public abstract Task<List<SelectListItem>> GetAccountListAsync(bool doGrouping);
    }
    ...
    public class AccountService : AbstractService<AccountService>, IAccountService {
        ...
        public async Task<List<SelectListItem>> GetAccountListAsync(bool doGrouping = false) {
            ...
            if (doGrouping) {
                ...
                result = await _context.Accounts
                    ...
                    .Select(acct => new SelectListItem { Value = acct.Id.ToString(), Text = acct.Name })
                    .ToListAsync();
            }
