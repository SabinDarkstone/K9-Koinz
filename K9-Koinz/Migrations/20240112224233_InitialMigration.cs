    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BudgetLineItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BudgetLineItem_Budget_BudgetId",
                        column: x => x.BudgetId,
                        principalTable: "Budget",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BudgetLineItem_Category_BudgetCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetLineItem_BudgetCategoryId",
                table: "BudgetLineItem",
                column: "BudgetCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetLineItem_BudgetId",
                table: "BudgetLineItem",
                column: "BudgetId");
